...
var nexrender = {
    renderCompositionName: 'Instagram_Story',
...
(function() {
    nexrender.selectLayersByName(null, 'Text_02', function(layer) {
        var parts = ["text","sourceText"];
        var value = { "value": 'ETHOVOX' }
...
(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Video_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/m9qsanxrqpc-sourceVideoPath.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/d28uv6cs8p-bg-video01.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_02', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/fgf5vg8p0vi-bg-video02.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_03', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/n5vstt1hjze-bg-video03.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_04', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/v149qok2jm-bg-video04.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Photo_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/6dhiba3lnwm-cover01.png', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Audio_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/KyFOEMvDHT8h64h6kh1eR/jcsa7e7eaz-news.mp3', false, false)
    }, null, undefined);
})();
