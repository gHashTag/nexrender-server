...
(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Video_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/xy5do2vzqqn-sourceVideoPath.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/o6y5pv95b8s-bg-video01.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_02', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/qt4fbpx15a-bg-video02.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_03', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/0ox8uk0789p-bg-video03.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_04', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/nxp9sc5ssb9-bg-video04.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Photo_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/1y5cnyo0h07-cover01.png', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Audio_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/-UyxPqowGDfJ3zViD-LMK/o9nwv9zr72-news.mp3', false, false)
    }, null, undefined);
})();
