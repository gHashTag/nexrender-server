...
(function() {
    nexrender.selectLayersByName('Text_02', 'Text_02', function(layer) {
...
(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Video_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/ihh60m47xo-sourceVideoPath.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/jvnoxzy32yp-bg-video01.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_02', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/alcha2a75k6-bg-video02.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_03', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/8fnf944vc5c-bg-video03.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'BG_04', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/msktfdn4slo-bg-video04.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Photo_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/61greykbj8y-cover01.png', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Audio_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/vh2Y0nteDsSXIZUxyJ-Ud/1zfn4fta9lw-news.mp3', false, false)
    }, null, undefined);
})();
