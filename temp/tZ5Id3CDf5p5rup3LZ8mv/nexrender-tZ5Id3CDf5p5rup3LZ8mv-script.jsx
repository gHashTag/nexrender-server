...
(function() {
    nexrender.selectLayersByName(null, 'Video_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/y6t7krsz1ph-sourceVideoPath.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName(null, 'BG_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/in67am3dnbo-bg-video01.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName(null, 'BG_02', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/gjfejzwloh5-bg-video02.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName(null, 'BG_03', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/g67446ut5bl-bg-video03.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName(null, 'BG_04', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/8vbn0bjx9vs-bg-video04.mp4', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName('Instagram_Story', 'Photo_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/81yrjjf14t-cover01.png', false, false)
    }, null, undefined);
})();

(function() {
    nexrender.selectLayersByName(null, 'Audio_01', function(layer) {
        nexrender.replaceFootage(layer, '/Users/playra/nexrender-server/temp/tZ5Id3CDf5p5rup3LZ8mv/vlameaeeklq-news.mp3', false, false)
    }, null, undefined);
})();
